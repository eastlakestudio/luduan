...
enum class CultureTheme(val rawValue: String) {
    ...
    companion object {
        fun from(raw: String): CultureTheme = entries.firstOrNull { it.rawValue == raw } ?: SHIHAN
    }
}
...
enum class BadgeCategory(val rawValue: String) {
    ...
    companion object {
        fun from(raw: String): BadgeCategory = entries.firstOrNull { it.rawValue == raw } ?: CHARACTER
    }
}
